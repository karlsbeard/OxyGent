...
async def _check_login_required(page):
    ...
    try:
        ...
        url_keywords = ["login", "signin", "sign-in", "auth", "passport", "账号", "登录"]
        ...
        login_keywords = [
            "登录", "登陆", "login", "sign in", "signin", "sign-in",
            "用户名", "账号", "邮箱", "username", "account", "email",
            "密码", "password", "验证码", "captcha", "verification",
            "忘记密码", "forgot password", "remember me", "记住我",
            "注册账号", "create account", "sign up", "注册"
        ]
...
async def _close_browser():
    """关闭浏览器"""
    global _browser, _context, _pages, _current_page_id, _data_ready, _operation_in_progress, _login_in_progress, _original_urls
